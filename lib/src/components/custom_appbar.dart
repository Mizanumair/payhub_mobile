  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      title: Row(
        ...
        children: [
          CustomText(text: title, color1: AppColors.black, fontWeight: fontWeight700, fontSize: font_17, textAlign: TextAlign.center),
          Padding(
            ...
            child: Container(
              ...
              child:  ElevatedButton(
                ...
                child: showSuffix==true? IconButton(onPressed: suffixPress, icon: Icon(icon), color: AppColors.black,) : CustomText(
                  text: text!,
                  color1: color!,
